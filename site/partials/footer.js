...
function renderFooter(prefix = "", page = "index.html") {
  ...
  <div class="max-w-[1440px] mx-auto px-6 py-14 sm:py-16 grid gap-8 md:gap-12 md:grid-cols-3">
    ...
    <div>
      <img src="${prefix}assets/logo.webp" alt="Ergoterapist Aleyna Keskin" width="1034" height="254" class="h-16 sm:h-20 w-auto max-w-full brightness-0 invert opacity-95">
